...
export const fakten: Fakt[] = [
  ...
  {
    id: "modus-info-default",
    aussage: "Nur lesen ohne Nachfrage. Vor Änderungen, Befehlen und Netzzugriffen fragt Claude. Gut für: jede Aktion selbst prüfen, sensible Arbeit.",
    wert: "default",
    quelle: DOKU.permissionModes,
    geprueftAm: GEPRUEFT,
    belegt: true,
  ...
  {
    id: "modus-info-acceptEdits",
    aussage: "Lesen, Dateien ändern und einfache Dateibefehle (z. B. Ordner anlegen, verschieben) ohne Nachfrage. Gut für: Arbeiten, die du danach prüfst.",
    wert: "acceptEdits",
    quelle: DOKU.permissionModes,
    geprueftAm: GEPRUEFT,
    belegt: true,
  ...
  {
    id: "modus-info-plan",
    aussage: "Lesen und planen. Änderungen erst, nachdem du den Plan freigegeben hast. Gut für: einen Überblick verschaffen, bevor sich etwas ändert.",
    wert: "plan",
    quelle: DOKU.permissionModes,
    geprueftAm: GEPRUEFT,
    belegt: true,
  ...
  {
    id: "modus-info-auto",
    aussage: "Alles, mit Sicherheitsprüfung im Hintergrund durch ein zweites Modell. Gut für: längere Aufgaben mit weniger Unterbrechungen.",
    wert: "auto",
    quelle: DOKU.permissionModes,
    geprueftAm: GEPRUEFT,
    belegt: true,
  ...
  {
    id: "modus-info-dontAsk",
    aussage: "Nur vorab erlaubte Werkzeuge. Alles, was nachfragen würde, wird abgelehnt. Gut für: abgesicherte Automatisierung.",
    wert: "dontAsk",
    quelle: DOKU.permissionModes,
    geprueftAm: GEPRUEFT,
    belegt: true,
  ...
  {
    id: "modus-info-bypassPermissions",
    aussage: "Alles, ohne Nachfrage und ohne Schutz. Gut für: nur isolierte Container und virtuelle Maschinen.",
  ...
  {
    id: "rewind",
    aussage: "Mit /rewind (oder zweimal Esc) springst du zu einem früheren Stand von Gespräch und Dateien zurück.",
    wert: "/rewind",
    quelle: DOKU.bestPractices,
    geprueftAm: GEPRUEFT,
    belegt: true,
  },
  {
    id: "permissions",
    aussage:
      "Mit /permissions erlaubst du einzelne Werkzeuge vorab oder sperrst sie. Sperr-Regeln gelten in jedem Modus, sogar in bypassPermissions.",
    wert: "/permissions",
    quelle: DOKU.permissionModes,
    geprueftAm: GEPRUEFT,
    belegt: true,
